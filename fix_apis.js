...
const recruitmentTs = import apiClient from './client';
...
const assetsTs = import apiClient from './client';
import { ApiResponse } from '../types';
...
const travelTs = import apiClient from './client';
import { ApiResponse } from '../types';
...
fs.writeFileSync('client/src/api/recruitment.ts', recruitmentTs);
fs.writeFileSync('client/src/api/assets.ts', assetsTs);
fs.writeFileSync('client/src/api/travel.ts', travelTs);
