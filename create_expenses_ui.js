const fs = require('fs');
const ui = `import React, { useState } from 'react';
...
import { Wallet, Plus, CheckCircle2, XCircle, IndianRupee } from 'lucide-react';
...
`;
fs.writeFileSync('client/src/pages/expenses/OfficeExpensesPage.tsx', ui);
console.log('Created OfficeExpensesPage UI');
